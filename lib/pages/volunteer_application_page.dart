...
class _VolunteerApplicationPageState extends State<VolunteerApplicationPage> {
  String _selectedRole = 'Coding Instructor';
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text(
                        'Rural Tech Education Initiative',
                ...
                _buildTextField(hint: 'Why do you want to join this project?', maxLines: 3),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: RichText(
                        text: const TextSpan(
                          style: TextStyle(fontFamily: 'Inter', fontSize: 12, color: AppColors.textMuted, height: 1.5),
                          children: [
                            ...
                            TextSpan(text: ' and commit to participating if approved.'),
                          ],
                        ),
                      ),
                    ),
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                // Simulate submission success and pop
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: <String>['Coding Instructor', 'Logistics Coordinator', 'General Volunteer'].map((String value) {
